# AST Consistency Report: ast_orig_ons1kkh6

**Source:** `/tmp/ast_orig_ons1kkh6.rs`
...
|----------|--------|-------------|-------------|
| `page_init` [page_init.diff](full/page_init.diff) [src](full/page_init_source.rs) [verus](full/page_init_verus.rs) | MISMATCH | 151-236 | 162-563 |
